    ...
    useEffect(() => {
        const fetchBalance = async () => {
            if (userId) {
                ...
                // Log all balances for the user
                balanceSnapshot.docs.forEach((balanceDoc) => {
                    const balanceData = balanceDoc.data();
                    console.log(`User ID: ${userId}, Balance: ${balanceData.balance}`);
                });

                // Set current balance from the first document
