export default function About2() {
  return (
    <>
      <section className="about-2 px-5">
            ...
            <div className="col-xl-6 col-md-12">
              ...
              >
                <h3 className="heading">
                  Why choose us? <br/> Invest wisely with Financial Trade Network
                </h3>
                <p className="fs-20 desc">
                  Our work outcome is our constantly increasing client quantity
                  and the company premium trust level where sustainable and
                  predictable market performance is the essential principle.
                </p>
                <ul className="list">
                  <li>
                    <div className="icon">
